    ...
    return (
        <div>
            ...
            <form className="flex flex-col pt-4 items-center gap-4 pointer-events-auto" onSubmit={handleSubmit}>
                ...
                <input className="font-serif text-[20px] w-30 rounded-md border-1 border-gray-600 focus:border-pink-600 pl-2" value={text1} placeholder="Password" onChange={handleChange1}></input>
